...
const Paginate = ({
    ...
    return (
        <nav className="flex">
            ...
            <button className="w-full px-4 py-2 border-t border-b text-base text-white font-semibold bg-amber-600" disabled={CurrentPag === Math.ceil(dogState / DogsPerPage)} onClick={nextPag}>Next</button>
